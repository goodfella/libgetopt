...
that they meet the criteria necessary to assign them to the
designated type for their respective option.  For example if an
argument is designated as an 'int', then libgetopt will check to
insure that the argument specified for a given option does not
